...
open class AltarBlockEntity(pos: BlockPos, state: BlockState, override val block: AltarBlock) : BlockEntity(Registrar.arcanology.blockEntity.altar, pos, state),
    BlockEntityWithBlock<AltarBlock> {
