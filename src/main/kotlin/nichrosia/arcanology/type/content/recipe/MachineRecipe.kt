...
abstract class MachineRecipe<I : MachineBlockEntity<*, *, *, *>, T : MachineRecipe<I, T>>(val input: ItemStack, override val result: ItemStack, types: KProperty0<MutableList<T>>) : SimpleRecipe<I, T>(types) {
    ...
    open class Type<I : MachineBlockEntity<*, *, *, *>, T : MachineRecipe<I, T>>(ID: ID) : SimpleRecipe.Type<I, T>(ID)
    abstract class Serializer<I : MachineBlockEntity<*, *, *, *>, T : MachineRecipe<I, T>>(ID: ID, types: KProperty0<MutableList<T>>) : SimpleRecipe.Serializer<I, T>(ID, types)
}