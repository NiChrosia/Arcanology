...
open class NormalOreConfig(
    ...
    val oreFeature by RegistrarProperty(Registrar.configuredFeature, name, false) { Registrar.configuredFeature.createOre(oreID, normalOre, oreBlobSize, blobsPerChunk, range, biomeSelector) }
