...
fun DependencyHandler.assemble(version: String = extension("assemble_version"), bundled: Boolean = false): Dependency? {
    return optionallyBundled("maven.modrinth:assemble:$version", bundled, this::modApi)
}
